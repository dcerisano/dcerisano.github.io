...
- Purpose: control a projector over BLE from a browser — scrolling text, solid color, video/audio/screensaver toggles, brightness/volume, and "Ambience" (live screen capture downsampled to 8x8 RGBA and streamed at 30 FPS).
